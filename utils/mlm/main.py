...
def main(args):
    ...
    train_file = pd.read_csv(args.data_path + "unofficial_train.csv")
    dev_file = pd.read_csv(args.data_path + "unofficial_valid.csv")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_dir", default="./mlm/model", type=str, help="Path to save, load model")
    parser.add_argument("--pred_dir", default="./mlm/preds", type=str, help="Directory that saves prediction files")
    parser.add_argument("--model_name_or_path", default="beomi/KcELECTRA-base", type=str, help="Model name or path")
    parser.add_argument("--tuned_model_path", default="./mlm/model/KcELECTRA/baseline", type=str, help="Finetuned model path")

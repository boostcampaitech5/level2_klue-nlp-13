...
parser.add_argument("--model_name_or_path", default="kykim/electra-kor-base", type=str, help="Model name or path")
parser.add_argument("--data_path", default="./data/", type=str, help="Model name or path")
parser.add_argument("--model_dir", default="./mlm/model/", type=str, help="Model name or path")
...
parser.add_argument('--do_pred',default=False)
